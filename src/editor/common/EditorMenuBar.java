...
import editor.common.EditorActions.AlignCellsAction;
import editor.common.EditorActions.AutosizeAction;
import editor.common.EditorActions.BackgroundAction;
import editor.common.EditorActions.BackgroundImageAction;
import editor.common.EditorActions.ColorAction;
import editor.common.EditorActions.ExitAction;
import editor.common.EditorActions.GridColorAction;
import editor.common.EditorActions.GridStyleAction;
import editor.common.EditorActions.HistoryAction;
import editor.common.EditorActions.JavaCodeGenAction;
import editor.common.EditorActions.KeyValueAction;
import editor.common.EditorActions.NewAction;
import editor.common.EditorActions.OpenAction;
import editor.common.EditorActions.PageBackgroundAction;
import editor.common.EditorActions.PromptPropertyAction;
import editor.common.EditorActions.PromptValueAction;
import editor.common.EditorActions.SaveAction;
import editor.common.EditorActions.ScaleAction;
import editor.common.EditorActions.SelectShortestPathAction;
import editor.common.EditorActions.SelectSpanningTreeAction;
import editor.common.EditorActions.SetLabelPositionAction;
import editor.common.EditorActions.StyleAction;
import editor.common.EditorActions.StylesheetAction;
import editor.common.EditorActions.ToggleAction;
import editor.common.EditorActions.ToggleGridItem;
import editor.common.EditorActions.ToggleOutlineItem;
import editor.common.EditorActions.TogglePropertyItem;
import editor.common.EditorActions.ToggleRulersItem;
import editor.common.EditorActions.WarningAction;
import editor.common.EditorActions.ZoomPolicyAction;
...
public class EditorMenuBar extends JMenuBar
{
	...
	public EditorMenuBar(final BasicGraphEditor editor, CodeEditor ce, GraphEditor ges)
	{
		...
		menu.add(editor.bind(mxResources.get("new"), new NewAction(ce), "./images/new.gif"));
		menu.add(editor.bind(mxResources.get("openFile"), new OpenAction(ce), "./images/open.gif"));
		menu.addSeparator();
		...
		menu.add(editor.bind(mxResources.get("saveJava"), new JavaCodeGenAction(ce, ges), "./images/savejava.png"));
