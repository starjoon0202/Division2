...
import editor.common.EditorActions.FontStyleAction;
...
import editor.common.EditorActions.PrintAction;
...
public class EditorToolBar extends JToolBar
{
	 ...
	 * 
	 */
	public EditorToolBar(final BasicGraphEditor editor, int orientation,  CodeEditor ce)
	{
		super(orientation);
		...
		add(editor.bind("New", new NewAction(ce),
				"./images/new.gif"));
		add(editor.bind("Open", new OpenAction(ce),
				"./images/open.gif"));
		add(editor.bind("Save", new SaveAction(false),
				"./images/save.gif"));
		add(editor.bind("Save As", new SaveAction(false),
				"./images/saveas.gif"));
		...
		fonts.addAll(Arrays.asList(new String[] { "Times New Roman", "Helvetica", "Verdana",
		...
		final JComboBox sizeCombo = new JComboBox(new Object[] { "12pt", "14pt", "18pt", "24pt", "30pt", "36pt",
				"48pt", "60pt" });
