...
import editor.GraphEditor.CustomGraph;
import editor.GraphEditor.CustomGraphComponent;
...
public class BasicGraphEditor extends JPanel
{
	 ...
	 * 
	 */
	public BasicGraphEditor(String appTitle, mxGraphComponent component,  CodeEditor ce)
	{
	...
	public BasicGraphEditor( CodeEditor ce)
	{
		this("Goal Model Editor", new CustomGraphComponent(new mxGraph()), ce);
	}
	/**
	 * 
	 */
	 ...
	 * 
	 */
	protected void installHandlers(CodeEditor ce)
	{
		rubberband = new mxRubberband(graphComponent);
		keyboardHandler = new EditorKeyboardHandler(graphComponent, ce);
	}

	/**
	 * 
	 */
	protected void installToolBar( CodeEditor ce)
	{
		add(new EditorToolBar(this, JToolBar.HORIZONTAL,ce), BorderLayout.NORTH);
	}
	...
	protected void installRepaintListener()
	{
		...
		graphComponent.getGraph().addListener(mxEvent.CELLS_ADDED,
				new mxIEventListener()
				{
					public void invoke(Object source, mxEventObject evt)
					{
												
						if (source instanceof CustomGraph)
						{
							mxGraph graph = ((CustomGraph) source);
							Object[] cells = (Object[]) evt.getProperties().get("cells");
							mxCell cell = (mxCell) cells[cells.length-1];
							TypeWriter window = new TypeWriter();
							window.inputTypeNewWindow(graphComponent, graph, cell);
						}
					}
				});
	}
	 ...
	 * 
	 */
	public void setLookAndFeel(String clazz,  CodeEditor ce)
	{
		JFrame frame = (JFrame) SwingUtilities.windowForComponent(this);
